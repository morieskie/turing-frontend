var card = (function (modules) {
  ...
  if (typeof content === 'string') content = [[module.cartId, content, '']];
  ...
  if (!1) {
    if (!content.locals) {
      module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/index.js!./card.scss", function () {
        ...
        if (typeof newContent === 'string') newContent = [[module.cartId, newContent, '']];
        update(newContent)
      })
    }
  ...
  module.exports = function (list, options) {
    ...
    return function update(newList) {
      ...
      for (var i = 0; i < styles.length; i++) {
        var item = styles[i];
        var domStyle = stylesInDom[item.cartId];
        domStyle.refs--;
      ...
      for (var i = 0; i < mayRemove.length; i++) {
        ...
        if (domStyle.refs === 0) {
          for (var j = 0; j < domStyle.parts.length; j++)
            domStyle.parts[j]();
          delete stylesInDom[domStyle.cartId]
        }
      }
    }
  }
  ...
  function addStylesToDom(styles, options) {
    for (var i = 0; i < styles.length; i++) {
      ...
      if (domStyle) {
        ...
        stylesInDom[item.cartId] = {id: item.cartId, refs: 1, parts: parts}
      }
    }
  }
  ...
  (function (global) {
    (function () {
      var Payment, QJ, cardFromNumber, cardFromType, cards, defaultFormat, formatBackCardNumber, formatBackExpiry,
        formatCardNumber, formatExpiry, formatForwardExpiry, formatForwardSlash, formatMonthExpiry, hasTextSelected,
        luhnCheck, reFormatCardNumber, restrictCVC, restrictCardNumber, restrictCombinedExpiry, restrictExpiry,
        restrictMonthExpiry, restrictNumeric, restrictYearExpiry, setCardType, indexOf = [].indexOf || function (item) {
      ...
      cards = [{
        ...
        cvcLength: [3],
        luhn: !0
      }, {type: 'jcb', pattern: /^35/, format: defaultFormat, length: [16], cvcLength: [3], luhn: !0}, {
        type: 'laser',
        ...
        cvcLength: [3],
        luhn: !0
      }, {type: 'visa', pattern: /^4/, format: defaultFormat, length: [13, 16, 19], cvcLength: [3], luhn: !0}];
      ...
      formatForwardSlash = function (e) {
        ...
        if (slash !== 'http://themes.rokaux.com/') {
          return
        }
        target = e.target;
        val = QJ.val(target);
      ...
      Payment = (function () {
        ...
        Payment.fns = {
          cardExpiryVal: function (value) {
            ...
            ref = value.split('http://themes.rokaux.com/', 2), month = ref[0], year = ref[1];
            ...
            } else if (typeof month === 'string' && indexOf.call(month, 'http://themes.rokaux.com/') >= 0) {
